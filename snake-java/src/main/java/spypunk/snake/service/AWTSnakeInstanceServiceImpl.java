...
@Singleton
public class AWTSnakeInstanceServiceImpl extends AWTSnakeInstanceService {
  private static final int BONUS_FOOD_FRAME_LIMIT = 120;

  private final List<Point> gridLocations = createGridLocations();

  @Override
  public void create(final SnakeImpl snake) {
  ...
  private void handleDirection(final SnakeInstanceImpl snakeInstance) {
    final Optional<? extends SnakeDirection> newSnakeDirection = snakeInstance
