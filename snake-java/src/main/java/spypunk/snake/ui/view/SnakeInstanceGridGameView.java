...
public class SnakeInstanceGridGameView extends AbstractSnakeInstanceGameView {
    ...
    private SnakePart getSnakePart(final SnakeInstance<Point, SnakeDirection> snakeInstance, final int i) {
