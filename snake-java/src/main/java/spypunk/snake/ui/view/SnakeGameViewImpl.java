...
public class SnakeGameViewImpl implements SnakeGameView {

    private final JFrame frame;

    private final SnakeInstanceGridGameView snakeInstanceGridView;

    private final SnakeInstanceScoreGameView snakeInstanceScoreView;

    private final SnakeInstanceStatisticGameView snakeInstanceNormalStatisticView;

    private final SnakeInstanceStatisticGameView snakeInstanceBonusStatisticView;
    ...
    public SnakeGameViewImpl(final SnakeController snakeController,
        ...
        snakeInstanceBonusStatisticView = new SnakeInstanceStatisticGameView(fontCache, snakeImageCache, snake, Type.BONUS);
