...
@Singleton
public class AWTSnakeControllerSnakeEventHandlerImpl extends AWTSnakeControllerSnakeEventHandler {

    private final Map<SnakeEvent, Supplier<SnakeControllerCommand<SnakeImpl>>> snakeControllerCommands = Maps
            .newHashMap();

    @Inject
    public AWTSnakeControllerSnakeEventHandlerImpl(final SnakeControllerCommandFactory controllerCommandFactory) {
    ...
    @Override
    public List<SnakeControllerCommand<SnakeImpl>> handleEvents(final List<SnakeEvent> snakeEvents) {
